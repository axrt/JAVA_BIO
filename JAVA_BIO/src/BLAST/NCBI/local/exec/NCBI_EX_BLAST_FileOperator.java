...
public class NCBI_EX_BLAST_FileOperator extends UtilFileOperator {
	 ...
	 * 
	 * @param fastaList
	 *            {@link List<Fasta>} of fata-formatted {@link Fasta} records as
	 *            a query input
	 * @param outputFile
	 *            {@link File} A file that will be created by the blast+
	 ...
	 * 
	 * @param outputFile
	 *            {@link File} A file that will automatically be created, fasta
	 ...
	 * 
	 * @param outputFile
	 *            {@link File} An XML file that will be created by the blast+
